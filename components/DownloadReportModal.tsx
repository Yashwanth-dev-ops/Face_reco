...
interface DownloadReportModalProps {
    onClose: () => void;
    onSubmit: (year: Year, section: string) => void;
    title: string;
}

export const DownloadReportModal: React.FC<DownloadReportModalProps> = ({ onClose, onSubmit, title }) => {
            ...
            >
                <div className="text-center">
                    ...
                    <p className="text-gray-400 mt-1">
                        Please select the year and section for the report.
                    </p>
                </div>
