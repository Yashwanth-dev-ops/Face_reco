...
export const MarksEntry: React.FC<MarksEntryProps> = ({ currentUser, studentDirectory, departments, onSaveMarks }) => {
    ...
    return (
        <div className="bg-slate-900/50 p-6 rounded-lg">
            <h3 className="text-2xl font-bold text-indigo-300 mb-4">Mid-Term Marks Entry</h3>
            ...
            {studentsLoaded && (
                <>
                    ...
                    <button onClick={handleSaveChanges} disabled={isLoading || filteredStudents.length === 0} className="w-full mt-4 px-6 py-3 rounded-lg font-semibold text-white bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 transition-all shadow-lg disabled:opacity-50">
